            ...
            <div className='flex flex-col j ustify-center md:flex-row overflow-x-hidden'>
                <div className='flex flex-col md:flex-row w-[86%] justify-center items-center mx-auto pt-10' data-aos="fade-right">  
                    <div className='flex justify-center items-center'>
                        <div className='flex flex-col items-center justify-center'>
                            <img src='https://res.cloudinary.com/dapbrn8a9/image/upload/v1723810021/Group_1171277268_gigzeg.webp' alt='unlocked' className='w-[96%]'/>
                            <div className='pt-5 font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Brand</div>
                            <div className='font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Collaboration</div>
                        </div>                  
                    </div>
                    <div class='flex justify-center items-center max-[768px]:pt-6'>
                        <div class='flex flex-col items-center justify-center'>
                            <img src='https://res.cloudinary.com/dapbrn8a9/image/upload/v1723810022/Group_1171277267_elvypm.webp' alt='unlocked' className='w-[96%]'/>
                            <div  className='pt-5 font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Creators</div>
                            <div className='font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Community</div> 
                        </div>                                
                    </div>
                </div>
                <div class='flex flex-col md:flex-row w-[86%] justify-center items-center mx-auto gap-5 pt-10' data-aos="fade-left">      
                    <div class='flex justify-center items-center'>
                        <div class='flex flex-col items-center justify-center'>
                            <img src='https://res.cloudinary.com/dapbrn8a9/image/upload/v1723810022/Group_1171277266_efdhrz.webp' alt='unlocked' className='pl-3'/>
                            <div  className='pt-6 font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Content</div>
                            <div className='font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Monetization</div>
                        </div>
                    </div>
                    <div class='flex justify-center items-center'>
                        <div class='flex flex-col items-center justify-center'>
                            <img src='https://res.cloudinary.com/dapbrn8a9/image/upload/v1723810022/Group_1171277265_ykdnqk.webp' alt='unlocked'/>
                            <div  className='pt-6 font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Automate</div>
                            <div className='font-Gilroy font-medium text-xl md:text-md lg:text-lg font-[#FFF]'>Content Promotion</div>
                        </div>
                    </div>
                </div>
            </div>
